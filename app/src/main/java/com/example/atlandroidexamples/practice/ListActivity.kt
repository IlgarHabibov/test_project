package com.example.atlandroidexamples.practice
...
//    private val adapter = SettingsAdapter(createSettingsList())
    ...
    private fun createSettingsList() = listOf(
        SettingsModel(name = "Language", R.drawable.ic_language),
        SettingsModel(name = "Notification", R.drawable.ic_notifications),
        SettingsModel(name = "Terms of Use", R.drawable.ic_terms_of_use),
        SettingsModel(name = "Privacy Policy", R.drawable.ic_privacy_policy),
        SettingsModel(name = "Chat support", R.drawable.ic_chat),
    )
